...
<LinkButton href="/product-development/glb-viewer/?model=siliconwit/spherical-cow.glb" variant="primary" icon="external" iconPlacement="start">
  View 3D Spherical Cow Model
</LinkButton>
