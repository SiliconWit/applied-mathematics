...
description: 'Understanding the power and limitations of abstraction in engineering through the lens of the famous "spherical cow" approach to modeling'
---
import AppliedMathematicsComments from './components/AppliedMathematicsComments.astro';
import DiscordWidget from './components/DiscordWidget.astro';
import AppliedMathematicsContributors from './components/AppliedMathematicsContributors.astro';
...
<AppliedMathematicsContributors />
...
Rather than implementing a full model from scratch, we'll explore key aspects of the spherical cow comparison code. The complete implementation is available on GitHub at [https://github.com/SiliconWit/applied-mathematics](https://github.com/SiliconWit/applied-mathematics) in the spherical cow modeling section.
...
1. "Spherical Cow Implementation" - [https://github.com/SiliconWit/applied-mathematics](https://github.com/SiliconWit/applied-mathematics)
